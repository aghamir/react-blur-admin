                ...
                <li className={`dropdown ${this.state.isExpanded ? 'open' : ''}`}>
                    ...
                    <div className='top-dropdown-menu dropdown-menu'>
                        ...
                        <div className='header clearfix'>
                            ...
                            {this.props.markAllAsReadOnClick ?
                                <a onClick={this.props.markAllAsReadOnClick}>Mark All as Read</a> : ''}
                            {this.props.settingsOnClick ? <a onClick={this.props.settingsOnClick}>Settings</a> : ''}
                        </div>
                        <div className='msg-list'>
                            {this.props.children}
                        </div>
                        {this.props.allMessagesOnClick ?
                            <a onClick={this.props.allMessagesOnClick}>See all messages</a> : ''}
                    </div>
                </li>
            </ul>
        );
