    ...
    renderOn() {
        return (
            <div className="bootstrap-switch-container">
                <span
                    className={`bootstrap-switch-handle-on bootstrap-switch-${this.props.type}`}>{this.props.onLabel}</span>
    ...
    renderOff() {
        return (
            <div className="bootstrap-switch-container">
                ...
                <span
                    className="bootstrap-switch-handle-off bootstrap-switch-default pull-right">{this.props.offLabel}</span>
            </div>
        );
    }
